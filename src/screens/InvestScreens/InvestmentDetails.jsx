...
const InvestmentDetails = () => {
  ...
  return (
    ...
    }).format(Number(investment?.investmentAmount)) : "0.00"}
    </Text>
    </View>
    ...
    {name === 'Arm' && (
      ...
      new Intl.NumberFormat('en-US', {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }).format(Number(portfolioDetail?.accountBalance)) : "0.00"}
      </Text>
      </View>
      )}
    ...
    {name === 'Arm' && (
      ...
      new Intl.NumberFormat('en-US', {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }).format(Number(investment?.topUpAmount)) : "0.00"}
      </Text>
      </View>
      )}
    ...
    {name === 'Arm' && (
      ...
      new Intl.NumberFormat('en-US', {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }).format(Number(investment?.redemptionAmount)) : "0.00"}
      </Text>
      </View>
      )}
    ...
    {name === 'Arm' && (
      ...
      new Intl.NumberFormat('en-US', {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }).format(Number(portfolioDetail?.accruedInterest)) : "0.00"}
    ...
    {name === 'Arm' && (
      investment?.trackingId && (<View style={styles.detailsView}>
    ...
    {name === 'Lenda' && (
      ...
      new Intl.NumberFormat('en-US', {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }).format(Number(investment?.monthlyReturn)) : "0.00"}
      </Text>
      </View>
      )}
    ...
    {name === 'Lenda' && (
      ...
      new Intl.NumberFormat('en-US', {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }).format(Number(investment?.dailyReturn)) : "0.00"}
      </Text>
      </View>
      )}
    ...
    {name === 'Lenda' && (
      ...
      new Intl.NumberFormat('en-US', {
        ...
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      }).format(Number(investment?.serviceCharge)) : "0.00"}
      </Text>
      </View>
      )}
